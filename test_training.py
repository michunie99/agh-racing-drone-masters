...
vec_env = DummyVecEnv([lambda: gym.make("race-aviary-v0") for _ in range(6)])
...
model = PPO("MlpPolicy", vec_env, verbose=1, tensorboard_log="./logs/ppo_test_drone/")
# print(model.policy)
